...
interface NavMenuProps {
  ...
  /** Accessible label for the close button. Editable via Sanity uiText. */
  closeLabel?: string;
}
 ...
 */
const NavMenu: React.FC<NavMenuProps> = ({ isOpen, onClose, menuData, onNavClick, closeLabel = 'Close menu' }) => {
