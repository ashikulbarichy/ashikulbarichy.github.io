...
const homeStructuredData = {
  ...
  'description': 'Portfolio and professional profile of Ashikul Bari Chowdhury, Cyber Security Analyst and GRC Specialist pursuing a Master of Cyber Security at La Trobe University, Melbourne.',
  'inLanguage': 'en-AU',
  'isPartOf': {
  ...
  return (
    <>
      <SEOHead
        ...
        description="Ashikul Bari Chowdhury — Cyber Security Analyst and GRC Specialist pursuing a Master of Cyber Security at La Trobe University, Melbourne, Victoria, Australia. Expert in governance, risk, compliance, Python, ASP.NET Core, and React. Actively seeking GRC Analyst, SOC Analyst, and Cybersecurity roles in Melbourne and across Australia."
